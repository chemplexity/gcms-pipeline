...
%   checksum = GetFileChecksum( __ , Name, Value)
%
% ------------------------------------------------------------------------
% Input (Optional)
% ------------------------------------------------------------------------
...
% ------------------------------------------------------------------------
%   checksum = GetFileChecksum()
%   checksum = GetFileChecksum('FID1A.CH')
%   checksum = GetFileChecksum('FID2B.CH', 'hash', 'SHA-1')
%   checksum = GetFileChecksum({'FID1A.CH', 'FID2B.CH'}, 'hash', 'SHA-512')
